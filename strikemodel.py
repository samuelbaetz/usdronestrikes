...
class StrikesapiStrike(models.Model):
...
class Strikesdata(models.Model):
    ...
    unnamed_12 = models.TextField(db_column='Unnamed: 12', blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters.
